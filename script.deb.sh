...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/jookies/jasmin-sms-gateway/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/jookies/jasmin-sms-gateway/config_file.list?os=${os}&dist=${dist}&source=script"

  apt_source_path="/etc/apt/sources.list.d/jookies_jasmin-sms-gateway.list"
  apt_keyrings_dir="/etc/apt/keyrings"
  if [ ! -d "$apt_keyrings_dir" ]; then
    install -d -m 0755 "$apt_keyrings_dir"
  fi
  gpg_keyring_path="$apt_keyrings_dir/jookies_jasmin-sms-gateway-archive-keyring.gpg"
    gpg_key_path_old="/etc/apt/trusted.gpg.d/jookies_jasmin-sms-gateway.gpg"
